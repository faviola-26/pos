...
public class CatalogController {
    ...
    public @ResponseBody List<Product> findProductByCharacteristics(@RequestParam List<Integer> idCharacteristic, @RequestParam List<String> valuesCharacteristic){
        return serviceProduct.findByCharacteristics(idCharacteristic, valuesCharacteristic);
    }
