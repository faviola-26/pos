...
public class ProductService{
    ...
    public List<Product> findByCharacteristics(List<Integer> idCharacteristic, List<String> valuesCharacteristic){
        return repository.findByCharacteristics(idCharacteristic, valuesCharacteristic);
    }
