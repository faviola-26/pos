...
INSERT INTO product_characteristic(id, name, type, format, value_interpreter, description) values
(null, 'Color', 4, '#<hex_num>', 1, 'shoe color');
INSERT INTO product_characteristic(id, name, type, format, value_interpreter, description) values
(null, 'Size', 3, '<number>.<half-number>', 3, 'shoe size');
INSERT INTO product_characteristic(id, name, type, format, value_interpreter, description) values
(null, 'Season', 6, 'season_name', 1, 'season of the year');
